...
const locales = {
  en: {
    ...
    pointThree: '7 languages, zero tracking',
  ...
  ru: {
    ...
    pointThree: '7 языков, нулевой трекинг',
  ...
  uk: {
    ...
    pointThree: '7 мов, нульовий трекінг',
  ...
  de: {
    ...
    pointThree: '7 Sprachen, kein Tracking',
  ...
  fr: {
    ...
    pointThree: '7 langues, zéro suivi',
  ...
  es: {
    ...
    pointThree: '7 idiomas, cero rastreo',
  ...
  zh: {
    ...
    languageLabel: '语言',
    eyebrow: '自然视频新标签页',
    heroTitle: '用一扇通往自然的活窗户，替换你无聊的新标签页。',
    heroText: 'Calm New Tab 将每个新标签页变成令人惊叹的高清自然视频——海浪、山间溪流、森林树冠等等。简洁的时钟和当地天气静静地显示在上方。没有多余内容。没有广告。没有追踪。只有宁静。',
    pointOne: '高清自然视频动态背景',
    pointTwo: '时钟、日期与当地天气',
    pointThree: '7种语言，零追踪',
    installNow: '免费获取 Calm New Tab',
    nextScene: '下一场景',
    footerCopy: '© 2026 CALM NEW TAB',
    footerFeatures: '功能',
    footerPrivacy: '隐私',
